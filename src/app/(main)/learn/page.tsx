...
export default function LearnPage() {
  ...
  useEffect(() => {
    async function loadItems() {
      try {
        setIsLoading(true);
        const data = await getStudyItems(20); // 20개 항목 가져오기
        ...
        // 신규/복습 항목 수 저장
        setNewItemsCount(data.newItems.length);
